...
from .funding_event_summary import FundingEventSummary

__all__ = ["FundingEventSummaryList"]


class FundingEventSummaryList(BaseModel):
    meta: PageMetadata
