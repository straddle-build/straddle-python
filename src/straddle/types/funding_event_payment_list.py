...
from .funding_event_payment import FundingEventPayment

__all__ = ["FundingEventPaymentList"]


class FundingEventPaymentList(BaseModel):
    meta: PageMetadata
