...
from .unmasked_compliance_profile import UnmaskedComplianceProfile
...
__all__ = ["UnmaskedCustomer"]


class UnmaskedCustomer(BaseModel):
    id: str
    ...
    compliance_profile: Optional[UnmaskedComplianceProfile] = None
