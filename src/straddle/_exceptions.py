...
class StraddleAPIError(Exception):
    pass


class APIError(StraddleAPIError):
    message: str
...
class WebSocketConnectionClosedError(StraddleAPIError):
...
class WebSocketQueueFullError(StraddleAPIError):
